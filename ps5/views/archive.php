	...
	<form method="post">
		<table>
			<tr>
				...
				<td colspan="3"><input class="resumeName" type="text" id = "resumeName"
					name="resumeName" value="<?php sticky('resumeName') ?>" /></td>
				<td></td>
				<td></td>
				<?php 
			...
			<tr>
				...
				<td><input type="submit" name="save" value="View" onClick = "openWindow()" /></td>
			</tr>
		</table>
	</form>
</body>
